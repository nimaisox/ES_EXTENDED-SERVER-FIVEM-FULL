...
Config.DrawDistance = 100 -- Distance of player and Marker to draw Marker for player
...
Config.discordHookStartWith = '**ES_Extended**' -- Start Discord Log with 
Config.discordHookSignature = 'Have Nice Day' -- Signature of discord log