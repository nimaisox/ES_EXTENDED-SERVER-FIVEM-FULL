...
ESX.RegisterServerCallback('esx_advancedgarage:checkMoneyAircrafts', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
	if xPlayer.getMoney('money') >= Config.AircraftPoundPrice then
		cb(true)
	else
		cb(false)
	end
...
ESX.RegisterServerCallback('esx_advancedgarage:checkMoneyBoats', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
	if xPlayer.getMoney('money') >= Config.BoatPoundPrice then
		cb(true)
	else
		cb(false)
	end
...
ESX.RegisterServerCallback('esx_advancedgarage:checkMoneyCars', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
	if xPlayer.getMoney('money') >= Config.CarPoundPrice then
		cb(true)
	else
		cb(false)
	end
...
ESX.RegisterServerCallback('esx_advancedgarage:checkMoneyPolicing', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
	if xPlayer.getMoney('money') >= Config.PolicingPoundPrice then
		cb(true)
	else
		cb(false)
	end
...
ESX.RegisterServerCallback('esx_advancedgarage:checkMoneyAmbulance', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
	if xPlayer.getMoney('money') >= Config.AmbulancePoundPrice then
		cb(true)
	else
		cb(false)
	end
...
AddEventHandler('esx_advancedgarage:payAircraft', function()
	...
	TriggerClientEvent("pNotify:SendNotification", source, {text =  _U('you_paid') ,type = "warning",queue = "duty", theme = "metroui", timeout = 2500,layout = "topRight" })
...
AddEventHandler('esx_advancedgarage:payBoat', function()
	...
	TriggerClientEvent("pNotify:SendNotification", source, {text =  "1500$ Ödedin",type = "warning",queue = "duty", theme = "metroui", timeout = 2500,layout = "topRight" })
...
AddEventHandler('esx_advancedgarage:payCar', function()
	...
	TriggerClientEvent("pNotify:SendNotification", source, {text =  "750$ Ödedin",type = "warning",queue = "duty", theme = "metroui", timeout = 2500,layout = "topRight" })
...
AddEventHandler('esx_advancedgarage:payPolicing', function()
	...
	TriggerClientEvent("pNotify:SendNotification", source, {text =  _U('you_paid' .. Config.PolicingPoundPrice),type = "warning",queue = "duty", theme = "metroui", timeout = 2500,layout = "topRight" })
...
AddEventHandler('esx_advancedgarage:payAmbulance', function()
	...
	TriggerClientEvent("pNotify:SendNotification", source, {text =  _U('you_paid' .. Config.AmbulancePoundPrice),type = "warning",queue = "duty", theme = "metroui", timeout = 2500,layout = "topRight" })
...
AddEventHandler('esx_advancedgarage:payhealth', function(price)
	...
	TriggerClientEvent("pNotify:SendNotification", source, {text = ( price .. "$ Ödedin"  ),type = "warning",queue = "duty", theme = "metroui", timeout = 2500,layout = "topRight" })
