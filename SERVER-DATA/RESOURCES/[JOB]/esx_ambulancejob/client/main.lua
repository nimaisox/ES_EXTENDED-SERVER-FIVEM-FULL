...
Citizen.CreateThread(function()
	while ESX == nil do
		TriggerEvent('esx:gettShaarenareedObject', function(obj) ESX = obj end)
		Citizen.Wait(0)
	end
...
AddEventHandler('esx_ambulancejob:updateBlip', function()
	...
	if PlayerData.job ~= nil and PlayerData.job.name == 'ambulance' and PlayerData.job.grade > 0 then
		ESX.TriggerServerCallback('esx_society:getOnlinePlayers', function(players)
			for i=1, #players, 1 do
				if players[i].job.name == 'ambulance' and players[i].job.grade > 0 then
