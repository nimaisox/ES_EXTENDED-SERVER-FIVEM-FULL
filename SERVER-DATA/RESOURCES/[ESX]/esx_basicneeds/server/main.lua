...
ESX.RegisterUsableItem('pastacarbonara', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'hunger', 200000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
	xPlayer.showNotification(_U('used_pastacarbonara'))
end)
...
ESX.RegisterUsableItem('macka', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'hunger', 200000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
	xPlayer.showNotification(_U('used_macka'))
end)
...
ESX.RegisterUsableItem('marabou', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'hunger', 200000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
	xPlayer.showNotification(_U('used_marabou'))
end)
...
ESX.RegisterUsableItem('loka', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'thirst', 200000)
	TriggerClientEvent('esx_basicneeds:onDrink', source)
	xPlayer.showNotification(_U('used_loka'))
end)
...
ESX.RegisterUsableItem('cigarett', function(source)
	...
	local lighter = xPlayer.getInventoryItem('lighter')
		...
		if lighter.count > 0 then
			...
			TriggerClientEvent('esx:showNotification', source, ('fandak nadarid'))
		end
end)
-------------------------------------------------------------------------------
